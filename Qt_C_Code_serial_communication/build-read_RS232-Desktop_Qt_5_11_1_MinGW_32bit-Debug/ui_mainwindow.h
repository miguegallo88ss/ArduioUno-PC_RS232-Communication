...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/rec/resource/quation_symbol.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        menuBaud_Rate = new QMenu(menuFile);
        ...
        menuFile->addAction(menuBaud_Rate->menuAction());
        menuFile->addAction(actionAbout_2);
        menuFile->addAction(actionExit);
        menuBaud_Rate->addAction(baud_300);
        menuBaud_Rate->addAction(baud_1200);
        menuBaud_Rate->addAction(baud_2400);
        menuBaud_Rate->addAction(baud_4800);
        menuBaud_Rate->addAction(baud_9600);
        menuBaud_Rate->addAction(baud_19200);
        menuBaud_Rate->addAction(baud_38400);
        menuBaud_Rate->addAction(baud_57600);
        menuBaud_Rate->addAction(baud_115200);
